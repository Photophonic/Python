...
for experimentNumber in range(10000):
    ...
    # CHANGE: Start at index 1, since you are looking at the previous one.
    for i in range(1, len(CoinFlip)):
        ...
        if streak == 6:
            numberOfStreaks += 1
            # CHANGE: Break after finding one 6-streak, since you don't want to double count in the same series of 100-flips.
            break
